...
var cnItems = {
    ...
    "Echinocactus": "仙人球",
    "Multiply Plant cost base above 1 by 0.99. Hold to buy max.": "将高于 1 的植物成本基数乘以 0.99。持有最多可购买。",
    "Previous Challenge Effects and Point Gain is divided by log10 Points": "之前的挑战效果和点数增益除以 log10 点数",
    "The Temperate Zone": "温带地区",
    "Multiply Point Gain by Temperate Zone Completions. (free) Hold to buy max.": "将点数增益乘以温带完成次数。（免费）持有最多可购买。",
    "Multiply Point Gain by Zones. (free) Hold to buy max.": "将点数增益乘以区域。（免费）持有可购买最多。",
